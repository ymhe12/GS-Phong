# 
# This code is borrowed and modified from https://github.com/learnables/learn2learn/blob/master/learn2learn/algorithms/maml.py.
#
        ...
        * **allow_nograd** (bool, *optional*, default=None) - Whether to allow adaptation with
        ...
        if allow_nograd:
            ...
            for name, param in self.module.named_parameters():
                if param.requires_grad and ("visibility_coef" in name or "fuse_weight" in name):
